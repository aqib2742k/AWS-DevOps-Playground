...
sudo mysql -e "CREATE DATABASE demo-db;"
sudo mysql -e "CREATE USER 'demo-user'@'localhost' IDENTIFIED BY 'password';"
sudo mysql -e "GRANT ALL PRIVILEGES ON demo-db.* TO 'demo-user'@'localhost';"
...
echo "Installation complete. Your demo website is now accessible at http://your_ec2_instance_public_ip/"
